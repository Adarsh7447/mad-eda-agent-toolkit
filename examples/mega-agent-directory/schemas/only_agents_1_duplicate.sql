create table public.only_agents_1_duplicate (
  ...
  team_id uuid null,
  rank smallint null,
  constraint only_agents_1_duplicate_pkey primary key (id)
) TABLESPACE pg_default;

create index IF not exists idx_only_agents_1_duplicate on public.only_agents_1_duplicate using btree (agent_email_zw) TABLESPACE pg_default;

create index IF not exists idx_only_agents_1_duplicate_phone on public.only_agents_1_duplicate using btree (agent_phone_numbers_zw) TABLESPACE pg_default;