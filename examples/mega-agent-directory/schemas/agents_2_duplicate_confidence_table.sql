create table public.agents_2_duplicate_confidence_table (
  ...
  aryan_107_teams_agents text null,
  constraint agents_2_duplicate_confidence_table_pkey primary key (id)
) TABLESPACE pg_default;

create index IF not exists agents_2_duplicate_confidence_table_deduplication_key_idx on public.agents_2_duplicate_confidence_table using btree (deduplication_key) TABLESPACE pg_default;

create index IF not exists agents_2_duplicate_confidence_table_normalized_full_name_idx on public.agents_2_duplicate_confidence_table using btree (normalized_full_name) TABLESPACE pg_default;