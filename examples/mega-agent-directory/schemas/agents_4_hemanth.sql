create table public.agents_4_hemanth (
  ...
  constraint agents_4_pkey primary key (id)
) TABLESPACE pg_default;

create index IF not exists agents_4_updated_at_idx on public.agents_4_hemanth using btree (updated_at) TABLESPACE pg_default;

create index IF not exists agents_4_team_id_idx on public.agents_4_hemanth using btree (team_id) TABLESPACE pg_default;