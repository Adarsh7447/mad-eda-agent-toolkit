create table public.agents_2 (
  ...
  constraint agents_2_pkey primary key (id)
) TABLESPACE pg_default;

create index IF not exists idx_agents_2_dedup on public.agents_2 using btree (deduplication_key) TABLESPACE pg_default;

create index IF not exists idx_agents_2_name on public.agents_2 using btree (normalized_full_name) TABLESPACE pg_default;