create table public.agents_3 (
  ...
  constraint agents_3_pkey primary key (id)
) TABLESPACE pg_default;

create index IF not exists idx_agents_3_dedup on public.agents_3 using btree (deduplication_key) TABLESPACE pg_default;

create index IF not exists idx_agents_3_name on public.agents_3 using btree (normalized_full_name) TABLESPACE pg_default;