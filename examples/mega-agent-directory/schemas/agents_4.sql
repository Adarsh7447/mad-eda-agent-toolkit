create table public.agents_4 (
  ...
  constraint agents_4_pkey1 primary key (id)
) TABLESPACE pg_default;

create index IF not exists agents_4_updated_at_idx1 on public.agents_4 using btree (updated_at) TABLESPACE pg_default;

create index IF not exists agents_4_team_id_idx1 on public.agents_4 using btree (team_id) TABLESPACE pg_default;